...
_INSTRUCTIONS = (
    ...
    "would distinguish it from the authors' account. Work these through "
    "properly and at length. They are your primary weaknesses and they go "
    "first in the list.\n\n"
    ...
    "job, however many items it returns.\n\n"
    ...
    "are flagging. A SOFT issue — friction or a fixable improvement that does "
    "not undermine the work — is a minor weakness. Reviewers run in parallel "
    ...
    "rather than re-deciding it yourself or dropping it silently. If a target "
