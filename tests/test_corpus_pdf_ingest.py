"""Optional coverage against an externally downloaded research PDF.

The mandatory integration contract lives in test_real_pdf_ingest.py and uses
an original committed fixture. This module supplements it with a larger paper.
...
put its Python package first on the path::
    ...
    PYTHONPATH=/path/to/rustypaper/python pytest tests/test_corpus_pdf_ingest.py
"""
...
CORPUS = os.environ.get(
    "RUSTYPAPER_CORPUS", str(Path(__file__).parent / "corpus")
)
